...
public class S5 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("4 + 6 + 8 +10 + ..... + x = 130");

        jLabel4.setText("Find x !");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Level 5", "Level 1", "Level 2", "Level 3", "Level 4" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            String confirmMessage = "4+(n−1)2 = x, n/2(a + Un) = 130";
            ...
            if (confirmOption == JOptionPane.NO_OPTION) {
                String hinMessage = "n = (x-2)/2 , (x-2/2)/2 (4 + x) = 130";
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (input.equals(String.valueOf(answer))) {
            JOptionPane.showMessageDialog(null, "Correct!, Congratulations You Finished All Levels");
            this.dispose();
        } else {
