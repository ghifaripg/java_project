...
public class S4 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("5, 8, 11, ....");

        jLabel4.setText("Find the 15th term !");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Level 4", "Level 1", "Level 2", "Level 3", "Level 4" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            String confirmMessage = "a=a1+(n−1)d";
            ...
            if (confirmOption == JOptionPane.NO_OPTION) {
                String hinMessage = "a15=5+(15−1)3";
