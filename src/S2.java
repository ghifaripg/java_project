...
public class S2 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("1783, 3178, 8317, ....");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Level 2", "Level 1", "Level 2", "Level 3", "Level 4" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            ...
            if (confirmOption == JOptionPane.NO_OPTION) {
                String hinMessage = "Shift the numbers to the right";
