...
public class S3 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("5, 8, ..., ..., 17");

        jLabel4.setText("Find the total of missing terms !");

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Level 3", "Level 1", "Level 2", "Level 4", "Level 5" }));
    ...
    private void jComboBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox3ActionPerformed
        String change = (String)jComboBox3.getSelectedItem();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            String confirmMessage = "Find the difference then add it";
